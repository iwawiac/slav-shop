...
@Component({
  selector: 'app-products-poster-list',
  templateUrl: './products-poster-list.component.html',
  styleUrls: ['./products-poster-list.component.css']
})
export class ProductsPosterListComponent {
